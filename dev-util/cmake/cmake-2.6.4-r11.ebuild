...
# $Header: /var/cvsroot/gentoo-x86/dev-util/cmake/Attic/cmake-2.6.4-r3.ebuild,v 1.9 2010/12/16 12:36:21 scarabeus Exp $

EAPI="4"

inherit elisp-common toolchain-funcs eutils versionator flag-o-matic cmake-utils rpm lts6-rpm
...
SRPM="cmake-2.6.4-5.el6.src.rpm"
...
src_prepare() {
	...
	SRPM_PATCHLIST="#Find UseVTK.cmake in /usr/lib64/vtk-* on 64-bit machines
