...
inherit autotools eutils python toolchain-funcs rpm lts6-rpm

DESCRIPTION="XSLT libraries and tools"
HOMEPAGE="http://www.xmlsoft.org/"
SRC_URI="ftp://xmlsoft.org/${PN}/${P}.tar.gz"
SRPM="libxslt-1.1.26-2.el6.src.rpm"
...
src_prepare() {
	# Omit the SRPM multilib patch, and use the vanilla Gentoo
	# ebuild.  Multilib support should already be available.
