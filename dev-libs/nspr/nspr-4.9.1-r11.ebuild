...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/nspr/nspr-4.9.1.ebuild,v 1.5 2012/07/29 17:34:30 armin76 Exp $

EAPI=4
WANT_AUTOCONF="2.1"

inherit autotools eutils multilib toolchain-funcs versionator rpm lts6-rpm
...
SRPM="nspr-4.9.1-2.el6_3.src.rpm"
...
src_prepare() {
	...
	SRPM_PATCHLIST="Patch1:         nspr-config-pc.patch
