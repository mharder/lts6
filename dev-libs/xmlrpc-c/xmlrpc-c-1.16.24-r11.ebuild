...
inherit eutils multilib rpm lts6-rpm

# Gentoo Maintainer notes:
# Take a look at http://xmlrpc-c.sourceforge.net/release.html
# We use "advanced" branch (Enterprise Linux version note: I think the stable
# version is used here), so for the current release revision take look here:
...
SRPM="xmlrpc-c-1.16.24-1200.1840.el6_1.4.src.rpm"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-curl-types-header.patch"
