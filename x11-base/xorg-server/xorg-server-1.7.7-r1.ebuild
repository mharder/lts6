...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/Attic/xorg-server-1.7.7-r1.ebuild,v 1.12 2011/03/27 17:23:01 ssuominen Exp $
...
IUSE="${IUSE_SERVERS} tslib ipv6 minimal nptl sdl"
RDEPEND="tslib? ( >=x11-libs/tslib-1.0 x11-proto/xcalibrateproto )
	dev-libs/openssl
