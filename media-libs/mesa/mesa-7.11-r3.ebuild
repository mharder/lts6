...
inherit base autotools multilib flag-o-matic python toolchain-funcs rpm lts6-rpm
...
src_unpack() {
	...
	unpack "./${MY_SRC_P}.tar.bz2" || die "unpack failed!"
}

src_prepare() {
	SRPM_PATCHLIST="Patch1: mesa-7.1-osmesa-version.patch
			Patch2: mesa-7.1-nukeglthread-debug.patch
			Patch3: mesa-no-mach64.patch
			Patch9: intel-revert-vbl.patch
			Patch30: mesa-7.6-hush-vblank-warning.patch
			Patch31: mesa-7.6-glx13-app-warning.patch
			Patch40: r300g-no-llvm.patch
			Patch60: mesa-7.11-b9c7773e.patch
			Patch70: mesa-7.11-gen6-depth-stalls.patch"
