...
# $Header: /var/cvsroot/gentoo-x86/dev-db/sqlite/Attic/sqlite-3.6.20-r1.ebuild,v 1.9 2010/01/02 18:27:30 armin76 Exp $

EAPI="4"

inherit eutils flag-o-matic multilib versionator rpm lts6-rpm

DESCRIPTION="an SQL Database Engine in a C Library"
HOMEPAGE="http://www.sqlite.org/"
DOC_BASE="$(get_version_component_range 1-3)"
DOC_PV="$(replace_all_version_separators _ ${DOC_BASE})"
SRPM="sqlite-3.6.20-1.el6.src.rpm"
...
src_unpack() {
	...
	if use doc ; then
		unpack "./sqlite_docs_3_6_20.zip" || die "unpack failed!"
	fi
}

src_prepare() {
	SRPM_PATCHLIST="Patch1: sqlite-3.6.12-libdl.patch
