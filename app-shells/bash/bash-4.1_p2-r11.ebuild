...
# $Header: /var/cvsroot/gentoo-x86/app-shells/bash/Attic/bash-4.1_p2-r1.ebuild,v 1.3 2010/05/20 03:00:24 vapier dead $
...
# bash-4.1_p9 to check for updates.
...
src_unpack() {
	...
	SRPM_PATCHLIST="Patch101: bash-2.02-security.patch
