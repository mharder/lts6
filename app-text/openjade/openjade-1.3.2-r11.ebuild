...
SRPM="openjade-1.3.2-36.el6.src.rpm"
...
src_prepare() {
	...
	# Covered by EL patch openjade-deplibs.patc
	# epatch "${FILESDIR}"/${P}-deplibs.patch
	# Covered by EL patch openjade-nola.patch
	# epatch "${FILESDIR}"/${P}-ldflags.patch
	epatch "${FILESDIR}"/${P}-msggen.pl.patch
	epatch "${FILESDIR}"/${P}-respect-ldflags.patch
	# Reviewed Gentoo Bug 293754 and confirmed the package
	# can currently build without /usr/lib/libosp.la
