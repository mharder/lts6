...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/cairo/Attic/cairo-1.8.8-r1.ebuild,v 1.8 2010/07/19 14:39:48 josejx Exp $

EAPI="3"

inherit eutils flag-o-matic autotools rpm lts6-rpm
...
src_prepare() {
	...
	if use lcdfilter; then
		...
		epatch "${FILESDIR}"/${PN}-1.8-lcd_filter.patch
