...
# $Header: /var/cvsroot/gentoo-x86/mail-mta/postfix/Attic/postfix-2.6.6.ebuild,v 1.11 2011/03/10 03:42:47 radhermit dead $
...
# regular ebuild
inherit eutils multilib ssl-cert toolchain-funcs flag-o-matic pam rpm lts6-rpm
# mailer-config support
#inherit eutils multilib ssl-cert toolchain-funcs flag-o-matic mailer pam rpm lts6-rpm
...
src_prepare() {
	SRPM_PATCHLIST="Patch1: postfix-2.6.1-config.patch
			...
			# This patch is for net-mail/pflogsumm
			# which is included in this SRPM
	...
	epatch "${FILESDIR}/postfix-linux-3.patch"
